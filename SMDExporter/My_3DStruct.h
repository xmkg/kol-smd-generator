...
public:
	...
	__Quaternion(){}
	/*__Quaternion(const D3DMATRIX& mtx);
...
{
public:
	unsigned __int32	dwColorOp, dwColorArg1, dwColorArg2;
	int	nRenderFlags; // 1-AlphaBlending | 2-안개랑 관계없음 | 4-Double Side | 8- ??
	unsigned __int32 dwSrcBlend; // 소스 블렌딩 방법
	unsigned __int32 dwDestBlend; // 데스트 블렌딩 방법
};
